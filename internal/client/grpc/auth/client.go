...
func (c *Client) Login(ctx context.Context, login string, passHash string) (string, error) {

	resp, err := c.api.Login(ctx, keeperv1.LoginRequest_builder{
		Login:        proto.String(login),
		PasswordHash: proto.String(passHash),
	}.Build())
...
func (c *Client) Register(ctx context.Context, login string, passHash string) (int64, error) {
